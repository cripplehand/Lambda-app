...
def goedkeuringB1():
    ...
    status = input('keur het studieplan van blok 1 goed of af: ')
    cursor.execute(
        "UPDATE studieplanB1 SET status=(?) WHERE studentnummer = (?)",
        (status,
         studentnummer))
    db.commit()
...
def goedkeuringB2():
    ...
    cursor.execute(
        "UPDATE studieplanB2 SET status=(?) WHERE studentnummer = (?)",
        (status,
         studentnummer))
    db.commit()
...
def goedkeuringB3():
    ...
    cursor.execute(
        "UPDATE studieplanB3 SET status=(?) WHERE studentnummer = (?)",
        (status,
         studentnummer))
    db.commit()
...
def goedkeuringB4():
    ...
    cursor.execute(
        "UPDATE studieplanB4 SET status=(?) WHERE studentnummer = (?)",
        (status,
         studentnummer))
    db.commit()
